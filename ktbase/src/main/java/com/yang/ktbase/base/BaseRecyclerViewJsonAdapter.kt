...
RecyclerView.Adapter<BaseViewHolder<V>>() {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<V>, position: Int) {
        onBindViewHolder(holder,holder.absoluteAdapterPosition,holder.binding,
            data.get(holder.absoluteAdapterPosition) as JsonObject
        )
    }

    abstract fun onBindViewHolder(holder: BaseViewHolder<V>,position: Int,binding: V,jsonObject:JsonObject)
